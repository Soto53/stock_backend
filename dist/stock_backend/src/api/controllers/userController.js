...
const createCompany = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { stockprice, symbol, name, exchange, datetime, open, high, low, close, volume, previous_close, change, average_volume, figi_code, } = req.body;
    const company = (0, userServices_1.CreateCompany)(stockprice, symbol, name, exchange, datetime, open, high, low, close, volume, previous_close, change, average_volume, figi_code);
